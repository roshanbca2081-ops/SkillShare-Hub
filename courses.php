...
<head>
    ...
    <title>Courses | SkillShare Hub</title>
    ...
    <div class="with-v-nav">
        ...
        <section class="page-banner" style="background:var(--gradient-dark);">
            <div class="container-max">
                ...
                <h1 style="color:#fff;font-size:var(--font-size-4xl);">Find Your Perfect <span class="text-gradient-secondary">Course</span></h1>
                <p style="color:rgba(255,255,255,.7);margin:0;">Learn from industry experts and advance your career.</p>
            </div>
        </section>
        ...
        <section class="section-padding">
            <div class="container-max">
                ...
                <div class="course-toolbar reveal">
                    <div class="results-count"><strong><span>6</span></strong> courses found</div>
                    <div class="toolbar-sort">
                        <label for="sortCourses">Sort by:</label>
                        <select id="sortCourses" class="filter-select">
