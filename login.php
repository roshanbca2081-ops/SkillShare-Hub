...
<head>
    ...
    <style>
        ...
        * {
        ...
        .password-strength .strength-bar.weak { width: 25%; background: var(--danger); }
        .password-strength .strength-bar.fair { width: 50%; background: var(--warning); }
        .password-strength .strength-bar.good { width: 75%; background: var(--primary-500); }
        ...
        .password-strength-text.good { color: var(--primary-400); }
        ...
        .btn-social.google:hover { border-color: #ea4335; background: rgba(234,67,53,0.08); }
        .btn-social.facebook:hover { border-color: #1877f2; background: rgba(24,119,242,0.08); }
        ...
        @media (max-width: 768px) {
            ...
            .auth-brand .logo-icon { font-size: 2.8rem; }
        ...
        @media (max-width: 480px) {
            ...
            .form-group .input-wrapper input,
            .form-group .input-wrapper select { font-size: 16px; padding: 10px 12px 10px 0; }
