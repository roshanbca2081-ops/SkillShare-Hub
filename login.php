...
<div class="page-section centered" style="min-height:calc(100vh - 120px);padding:50px 0;">
  <div class="auth-grid" style="position:relative;">
    ...
    <section class="auth-panel form-card animate" data-augmented-ui>
      ...
      <form method="post" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="input-icon"><i class="fa-solid fa-lock"></i><input type="password" name="password" class="form-control" placeholder="Password" required data-password-field />
          <button class="password-toggle" type="button" data-password-toggle aria-label="Show password"><i class="fa-regular fa-eye"></i></button></div>
      ...
      <div class="auth-form-actions">
        <button class="social-btn google" type="button"><i class="fa-brands fa-google"></i> Login with Google</button>
        <button class="social-btn facebook" type="button"><i class="fa-brands fa-facebook"></i> Login with Facebook</button>
      </div>
