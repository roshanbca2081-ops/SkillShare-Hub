  ...
  <section class="container py-5">
    <div class="card p-4" style="max-width:700px;margin:0 auto;">
      <div class="page-title">
        <div>
          <h1>Fresher Settings</h1>
          <p>Update notifications, privacy, and account preferences.</p>
        </div>
      </div>
      <div class="row g-4">
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <div class="soft-card">Email alerts for assignments, session reminders, and account updates.</div>
        </div>
      </div>
