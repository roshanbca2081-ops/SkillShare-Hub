...
$transaction_id = 'FP-' . time() . '-' . $user_id;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO bookings (fresher_id, session_id, payment_method, payment_status, transaction_id, payment_date, status) 
                           VALUES (?, ?, 'fonepay', 'paid', ?, NOW(), 'approved')");
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5 text-center">
                            <div class="mb-4">
                                ...
                                <h3 class="mt-3">Fonepay Payment</h3>
                                <p class="text-muted">Complete your payment using Fonepay</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <ol class="text-start">
                                    <li>Open your Fonepay mobile app or visit <a href="https://fonepay.com" target="_blank">fonepay.com</a></li>
                            ...
                            <form method="POST">
                                <div class="mb-3">
                                    <label class="form-label">Fonepay Transaction ID</label>
                                    <input type="text" name="transaction_id" class="form-control" value="<?php echo $transaction_id; ?>" required>
                                    <small class="text-muted">Enter the transaction ID from your Fonepay payment</small>
                                </div>
