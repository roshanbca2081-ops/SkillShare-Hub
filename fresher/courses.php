    ...
    <section class="container page-section">
      <div class="card card--padded animate" style="max-width:900px;margin:auto;">
        <div class="page-title">
          <div>
            <h1>Courses</h1>
            <p>Browse available courses (Phase 3 starter).</p>
          </div>
        </div>
  ...
  <script>
    ...
    function renderCourses(courses){
      ...
      if (!courses || courses.length === 0){
        el.innerHTML = '<div class="alert alert-info">No courses available yet.</div>';
        return;
      }
        ...
        <div class="soft-card mb-3">
          <div class="d-flex justify-content-between align-items-start gap-3">
            <div>
              ...
              <div class="small text-light-emphasis mt-1">${c.description ? c.description : ''}</div>
            </div>
