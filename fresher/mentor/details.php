...
// Get courses
$stmt = $pdo->prepare("SELECT * FROM courses WHERE mentor_id = ? AND status = 'active' ORDER BY featured DESC, created_at DESC");
$stmt->execute([$mentor_id]);
...
$stmt = $pdo->prepare("SELECT r.*, u.full_name, u.avatar 
                       ...
                       WHERE r.mentor_id = ? AND r.is_public = 1
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <p class="mt-3"><i class="fas fa-map-marker-alt text-primary"></i> <?php echo htmlspecialchars($mentor['location']); ?></p>
                            <?php endif; ?>
                            
                            <?php if ($mentor['website']): ?>
                            <p><i class="fas fa-globe text-primary"></i> <a href="<?php echo $mentor['website']; ?>" target="_blank"><?php echo $mentor['website']; ?></a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <h4>Courses by <?php echo htmlspecialchars($mentor['full_name']); ?></h4>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="../../public/course-detail.php?id=<?php echo $course['id']; ?>" class="btn btn-sm btn-outline-primary mt-2 w-100">
                                                    View Course
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <?php if (!empty($reviews)): ?>
                                ...
                                <div class="d-flex border-bottom pb-3 mb-3">
                                    <img src="<?php echo getAvatar($review); ?>" class="rounded-circle me-3" style="width: 40px; height: 40px; object-fit: cover;">
                                    <div>
