<?php
// Shared fresher dashboard topbar
?>
<div class="dash-topbar">
    ...
    <div class="dt-right">
        ...
        <button class="dt-avatar-btn"><img src="../../assets/images/profile/avatar-1.svg" alt="Fresher"><span><?php echo ucfirst($sidebar_role); ?></span><i class="fa-solid fa-chevron-down" style="font-size:.7rem;color:var(--gray-500);"></i></button>
    </div>
</div>
