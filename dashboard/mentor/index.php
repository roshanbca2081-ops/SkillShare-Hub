...
<head>
    ...
    <title>Mentor Dashboard | ShareSkill Hub</title>
    ...
    <main class="main-content">
        ...
        <header class="top-header">
            <div class="greeting">
                <div style="display:flex;align-items:center;gap:12px;">
                    ...
                    <div>
                        ...
                        <p>Here's what's happening with your teaching journey</p>
                    </div>
                </div>
            </div>
            <div class="header-actions">
                ...
                <div class="profile">
                    <img src="../../assets/images/profile/avatar-1.svg" alt="Mentor">
                    <span>Mentor</span>
                </div>
            </div>
        </header>
        ...
        <div class="learning-animation">
            <div class="text-content">
                ...
                <a href="my-courses.php" class="btn-view">
        ...
        <!-- ============================================
           ...
           ============================================ -->
        <div class="section-header">
            <h3><i class="fas fa-fire" style="color:var(--warning);margin-right:8px;"></i>My Courses</h3>
            <a href="my-courses.php">View All →</a>
        </div>
...
<script>
    ...
    // CONSOLE
    // ============================================
    console.log('📊 ShareSkill Hub - Mentor Dashboard Loaded');
    console.log('🎓 12 Courses | 240 Students | 18 Sessions | $8.7k Earnings');
</script>
